...
// Alternate upload path with the same contract as uploadFileToS3 — kept as a
// separate function/route (rather than merged) so the two entry points can be
// deployed, throttled, or evolved independently if their usage patterns diverge.
